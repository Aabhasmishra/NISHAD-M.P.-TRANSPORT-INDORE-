...
const Challan = ({ isLightMode, modeOfView, currentUser }) => {
    ...
    for (const builtyNo of builtyNos) {
        try {
        const response = await fetch(`${BASE_URL}/transport-records?grNo=${builtyNo}`);
    ...
    for (const builtyNo of builtyNos) {
        try {
        await fetch(`${BASE_URL}/transport-records/${builtyNo}/status`, {
            method: 'PUT',
    ...
    const updateRemovedBuiltyStatuses = async () => {
        for (const builtyNo of removedBuiltyNos) {
            try {
                const response = await fetch(`${BASE_URL}/transport-records/${builtyNo}/status`, {
                    method: 'PUT',
                    headers: { 'Content-Type': 'application/json' },
    ...
    showConfirm('Delete this challan? This will unassign its builty numbers.', async () => {
        ...
        const response = await fetch(`${BASE_URL}/challan/${challanNo}`, { method: 'DELETE' });
    ...
    const handleSearch = async (e) => {
        ...
        try {
            ...
            const response = await fetch(`${BASE_URL}/challan?challan_no=${formattedChallanNo}`);
